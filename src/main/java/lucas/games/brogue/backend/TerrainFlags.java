...
public class TerrainFlags {
    ...
    public static final int OBSTRUCTS_SURFACE_EFFECTS   = 1 << 3;  // Grass, blood, etc. can't be on this tile
    public static final int OBSTRUCTS_GAS               = 1 << 4;  // Blocks permeation of gas
    public static final int OBSTRUCTS_DIAGONAL_MOVEMENT = 1 << 5;  // Cannot step diagonally around this tile
    public static final int SPONTANEOUSLY_IGNITES       = 1 << 6;  // Catches fire spontaneously, monsters avoid unless chasing player or immune to fire
    public static final int AUTO_DESCENT                = 1 << 7;  // Automatically drops creature a depth level and does some damage (2d6)
    ...
    public static final int IS_FIRE                     = 1 << 11; // Terrain is a type of fire; ignites neighbouring flammable terrain
    public static final int ENTANGLES                   = 1 << 12; // Entangles player and monsters like a spiderweb
    ...
    public static final int CAUSES_PARALYSIS            = 1 << 16; // Any creature on the tile becomes paralyzed
    public static final int CAUSES_CONFUSION            = 1 << 17; // Any creature on the tile becomes confused
    public static final int CAUSES_HEALING              = 1 << 18; // Heals 20% max HP per turn for any player or non-inanimate monster
    ...
    public static final int SACRED_GROUND               = 1 << 21; // Monsters that aren't allies of the player will avoid stepping here
